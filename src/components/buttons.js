...
class Pause extends React.Component {
  render(){
    ...
    return <svg id={this.props.id} className="play_button" width="80px" height="80px" viewBox="-8 -8 96 96" version="1.1">
    ...
    return <svg id={this.props.id} className="pause_button" width="80px" height="80px" viewBox="-8 -8 96 96" version="1.1">
        <g id="Pause"  stroke={this.props.stroke} fillRule="evenodd" >
            <ellipse id="Oval" fill={this.props.circle} cx="40" cy="40" rx="40" ry="40" stroke="none"></ellipse>
